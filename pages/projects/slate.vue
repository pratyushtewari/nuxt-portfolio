<template>
  <div>
    ...
    <h3>This report covers the field research process and findings for SLATE’s semester-long Capstone project at Carnegie Mellon University’s Human-Computer Interaction Institute.</h3>
      <grid col=3 col-s=1 >
            <c span=1>
            <DefinitionBox
              :data="[
